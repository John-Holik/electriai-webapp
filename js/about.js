      ...
      <div className="animate-fade py-8 max-w-3xl">
        ...
        <section className="mb-10">
          ...
          <div className="text-slate-700 leading-relaxed text-base space-y-4">
            ...
            <p>
              In the second stage, an automated classifier re-read all 14,980 detected questions and classified them into a literature-grounded taxonomy of ten substantive question types (a residual class, Q11 social or rhetorical, is excluded from the gap analysis) and ten answer mechanisms (A1 to A10). A consolidation pass then grouped the 12,933 substantive questions into 263 recurring question families and the answered rows into 204 answer families. The headline finding is that 60.2 percent of substantive questions never receive a reply, while 71.2 percent of replied questions get a substantive answer, so knowledge bottlenecks are read off per question type and family. The first-stage subject classification was human-validated through the Qualtrics surveys (Table 1 on the Findings tab).
            </p>
            <p>
        ...
        <section className="mb-10">
          ...
          <pre className="bg-white border border-slate-200 rounded-lg px-4 py-3 text-[12px] font-mono text-slate-800 whitespace-pre-wrap leading-relaxed">
            {`@unpublished{knowledgebottleneck2026,\n  title  = {${REDACTED}},\n  author = {${REDACTED}},\n  year   = {2026},\n  note   = {Manuscript in preparation}\n}`}
          </pre>
        </section>
